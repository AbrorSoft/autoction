...
class ProductCriteriaTest {
    ...
    private static void setAllFilters(ProductCriteria productCriteria) {
        productCriteria.id();
        productCriteria.auctionCategory();
        productCriteria.lotNumber();
        productCriteria.authorName();
        productCriteria.producedYear();
        productCriteria.classification();
        productCriteria.estimatedPrice();
        productCriteria.description();
        productCriteria.auctionDate();
    ...
    private static Condition<ProductCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getAuctionCategory()) &&
                condition.apply(criteria.getLotNumber()) &&
                condition.apply(criteria.getAuthorName()) &&
                condition.apply(criteria.getProducedYear()) &&
                condition.apply(criteria.getClassification()) &&
                condition.apply(criteria.getEstimatedPrice()) &&
                condition.apply(criteria.getDescription()) &&
                condition.apply(criteria.getAuctionDate()) &&
    ...
    private static Condition<ProductCriteria> copyFiltersAre(ProductCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getAuctionCategory(), copy.getAuctionCategory()) &&
                condition.apply(criteria.getLotNumber(), copy.getLotNumber()) &&
                condition.apply(criteria.getAuthorName(), copy.getAuthorName()) &&
                condition.apply(criteria.getProducedYear(), copy.getProducedYear()) &&
                condition.apply(criteria.getClassification(), copy.getClassification()) &&
                condition.apply(criteria.getEstimatedPrice(), copy.getEstimatedPrice()) &&
                condition.apply(criteria.getDescription(), copy.getDescription()) &&
                condition.apply(criteria.getAuctionDate(), copy.getAuctionDate()) &&
